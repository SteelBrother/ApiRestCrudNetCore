    ...
    public partial class Migracion1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoLugarEntrega", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TipoVehiculoEntrega",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoVehiculoEntrega", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdTipoLugarEntrega = table.Column<int>(type: "int", nullable: false),
                    Direccion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TipoLugarEntregaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LugarEntrega", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LugarEntrega_TipoLugarEntrega_TipoLugarEntregaId",
                        column: x => x.TipoLugarEntregaId,
                        principalTable: "TipoLugarEntrega",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdTipoVehiculoEntrega = table.Column<int>(type: "int", nullable: false),
                    Matricula = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NombreConductor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdTipoVehiculoEntregaNavigationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehiculoEntrega", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehiculoEntrega_TipoVehiculoEntrega_IdTipoVehiculoEntregaNavigationId",
                        column: x => x.IdTipoVehiculoEntregaNavigationId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdVehiculoEntrega = table.Column<int>(type: "int", nullable: false),
                    IdCliente = table.Column<int>(type: "int", nullable: false),
                    ClienteId = table.Column<int>(type: "int", nullable: true),
                    VehiculoEntregaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Entrega_VehiculoEntrega_VehiculoEntregaId",
                        column: x => x.VehiculoEntregaId,
                        principalTable: "VehiculoEntrega",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdTipoEnvio = table.Column<int>(type: "int", nullable: false),
                    ...
                    IdEntregaNavigationId = table.Column<int>(type: "int", nullable: true),
                    IdRegistroNavigationId = table.Column<int>(type: "int", nullable: true),
                    IdTipoEnvioNavigationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entrega_VehiculoEntregaId",
                table: "Entrega",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LugarEntrega_TipoLugarEntregaId",
                table: "LugarEntrega",
                column: "TipoLugarEntregaId");
